...
ytt -f config -f config-optional/remove-resource-requirements.yml -f config-optional/add-metrics-server-components.yml -f config-optional/patch-metrics-server.yml -f $CF_VALUES > $CF_RENDERED
